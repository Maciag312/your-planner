    ...
    return (props.authenticated?<Redirect to='/Planner' />:
        <div>
            ...
            <div className={classes2.root}>
                ...
                <TextField label="password" type="password"></TextField><br></br><br></br>
            </div>
            <div className={classes.root}>
                <Link className="Link"  to='/registration'>Or sign in</Link><br></br><br></br>
                <div className="signinbutton">
                    <ColorButton variant="contained" onClick={signin} color="primary"> Sign in </ColorButton>
                </div>
            </div>
